...
<legend align="center">Sales Voucher</legend>	
<fieldset id="dashboard" style="width:47.7%;float:right;">

	<legend>Voucher Details</legend>
	<label>Invoice No.</label> 
	<input name="invno" type="text" value="<?php $sql='SELECT max(invno) from sales';
...
<p><strong><span style=" width:auto;float:right;"> Total:<input style=" width:auto;float:right;"type="text" name="total" id='total' readonly value="0"></strong></span><br><input align=center type="submit" value="Continue" id="SUBMIT" align="center">	
</fieldset>

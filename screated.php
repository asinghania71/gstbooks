...
$sql.="INSERT INTO `sales`(`invno`, `acname`, `date`, `gstin`, `itemname`, `HSN`, `gstrate`, `rate`, `qty`, `amount`, `cgst`, `sgst`, `igst`, `namount`) VALUES ('".$_POST['invno']."', '".$_POST['bname']."', '".$_POST['invdate']."', '".$_POST['bgstin']."', '".$_POST["iname".$x]."','".$_POST["hsn".$x]."','".$_POST["gstrate".$x]."', '".$_POST["qty".$x]."', '".$_POST["rate".$x]."', '".$_POST["amount".$x]."', '".$_POST["igst".$x]."', '".$_POST["sgst".$x]."', '".$_POST["cgst".$x]."', '".$_POST["namount".$x]."');";
// echo $sql;
$x=$x+1;
}
...
<p align="center"><a href="#" onClick="MyWindow=window.open('sprint.php?inv=<?php echo $_POST['invno'];?>','Print',width=600,height=300); return false;">Click Here to Print</p>

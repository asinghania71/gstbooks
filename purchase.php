...
<div class="main" id="n">
<form action="pcreated.php" method="post" id="vc">
...
<legend align="center">Sellers Detail </legend>	
...
?>
	...
	<label>Seller's GSTIN: </label><input type="text" name="bgstin" id="bgstin" readonly>	<br>
	<label>Seller's State:</label><input type="text" name="bstate" id="bstate" readonly></label><br>
</fieldset><p>		<br><br>
